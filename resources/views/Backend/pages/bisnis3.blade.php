...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Rahasia Pemasaran Online yang Efektif untuk Bisnis')

@section('content')

<body>
    <h1 class="display-3"><b>Rahasia Pemasaran Online yang Efektif untuk Bisnis</b></h1>
    <br />
    ...
    <div class="full-image-container">
        <img src="./Backend/dist/image-konten/bisnis3.jpg" alt="bisnis1" style="max-width: 100%; height: auto;"  class="img-fluid"/>
    </div>
    <div class="text pt-3 text-size">
        <p>
            Praktik terbaik dalam hal ini dimulai dengan pemahaman mendalam terhadap kebutuhan pelanggan. Dengan merinci preferensi, harapan, dan umpan balik, perusahaan dapat membentuk strategi yang lebih personal dan responsif.
            Pemahaman yang kuat tentang pelanggan menciptakan dasar yang diperlukan untuk mengembangkan produk dan layanan yang sesuai dengan kebutuhan pasar yang terus berubah.
        </p>
